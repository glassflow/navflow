...
ck("statusCode -> numeric field", envs[0].fields.get("statusCode") == 200, str(envs[0].fields))
...
ck("proxy statusCode -> field", envs[1].fields.get("statusCode") == 500, str(envs[1].fields))
